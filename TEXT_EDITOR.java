...
class TextEditor implements ActionListener {
    ...
    TextEditor(){
        ...
        f.addWindowListener(new WindowListener() {
            ...
            public void windowClosing(WindowEvent e) {
                int confirmExit = JOptionPane.showConfirmDialog(f,"Do you want to exit from the editor?","Confirm Before Saving...",JOptionPane.YES_NO_OPTION);
    ...
    public void saveTheFile(){
        ...
        try {
            ...
            writeContent.close();
            JOptionPane.showMessageDialog(f,"Your File Successfully saved!");
        }catch (Exception ex){
            ex.printStackTrace();
        }
    }
